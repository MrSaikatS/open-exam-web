...
const AdminTopicQuestionsPage = async ({
  params,
}: {
    ...
    <section className="grid gap-8">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link
            href={
              `/admin/questions/subjects/${topic.subject.id}` as Route
            }>
            <Button
              variant="outline"
              size="icon-lg">
        ...
        <Link
          href={
            `/admin/questions/topics/${topic.id}/new` as Route
          }>
          <Button
            variant="outline"
            size="lg">
...
export default AdminTopicQuestionsPage;
