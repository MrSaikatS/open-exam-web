...
import DeleteTopicButton from "@/components/Bank/DeleteTopicButton";
...
const AdminSubjectTopicsPage = async ({
  params,
}: {
    ...
    <section className="grid gap-8">
      <div className="flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href={"/admin/questions" as Route}>
            <Button
              variant="outline"
              size="icon-lg">
                ...
                <tr
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-end gap-1">
                      <Link
                        href={
                          `/admin/questions/topics/${topic.id}` as Route
                        }>
                        <Button
                          variant="outline"
                          size="lg">
...
export default AdminSubjectTopicsPage;
